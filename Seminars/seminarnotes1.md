...
I have no experience about using aboved tools, but from other's using experience, I know that Jenkins is a open-source continuous integration tool which is developed in Java. It has two major jobs: building/testing software project continuously and monitoring externally run jobs. We are able to build Apache Ant and Apache Maven based projects and other shell scripts or batch files for the pre or the post-build activities.
...
1.Compare all requirements to the product strategies to ensure that the requirements follow the management demand.
...
a. (Description) make a brief description about the requirement b.(Benefit&Reason) The content about why this requirement and the benefit of implementing this requirement should be explained c.(Risks) describe the potential risk d.(Title) build a title of the requirement within 5 words
...
In addition, i think that the evolution of RAM will go on, incorporating explicit support for requirements estimation, risk analysis, prioritization and requirements packaging into development practice. As the author mentioned that the work name for this endeavor isRAMv.2.0. Requirements engineering closer to and within projects will be incorporated.
...
In this paper, the author presents a method for early requirements triage and selection utilizing product strategies.
...
Step 1:Specify product-technology roadmap: For this step, we have to draw a product-technology roadmap for help us understand the relationship between releases and technology generations.

Step 2:Estimate resource: Based on the result of the Step 1, we have to analyze the feasibility of the requirements. Estimate their cost, effort and time based on different methods.

For the author's conclusion, the use of MERTS requires times and resources to understand and formalize. Meanwhile a "tailoring" is made to make the MERTS to fit different sizes of enterprises.
...
Level of quality can change different variables.
...
For Product, the dependent variables relate requirement selection and degree of impact.
For Company, the dependent variables relate to Portfolio management, Strategic alignment and degree of impact.
For Society, the dependent variables relate to positive and negative externalities

I think the conclusion that made by the author are important and helpful. At a higher level of taxonomy, We need to realize that the effects are multidisciplinary and multi-perspective. The higher level of taxonomy, the content will be more complex which including the content of lower level of taxonomy, the dependent variables are different.
From the Figure2.Forsberg study of NASA projects we can see from the picture that, the higher the project cost for requirement, the lower project cost overrun within a certain range. As we known from the previous study that, the high quality of requirement can make the project process go on better.
In another way, as the author mentioned that for every incoming requirements, we should judge and analyze them based on their relationship among other levels.
...
In this paper, the author mainly introduces the cost-value approach for prioritizing requirements which can help effectively and accurately manage the system requirement from stakeholders.
...
5.Stakeholders use cost-value diagram to discuss about the candidate requirements and select some candidate requirements for RP.
...
I think the approach the author points out is useful and easy to realize. The cost and value is what we have to balance when we do the software requirement. Through such a value-cost diagram we can directly judge whether a candidate requirement is suitable for our development.
...
[4]Suomalainen T, Salo O, Abrahamsson P, et al. Software product roadmapping in a volatile business environment[J]. Journal of Systems and Software, 2011, 84(6): 958-975.

[5]Gorschek T. Requirements engineering supporting technical product management[J]. 2006.
